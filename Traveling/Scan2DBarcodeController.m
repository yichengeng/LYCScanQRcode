//
//  Scan2DBarcodeController.m
//  PlazaTravel
//
//  Created by liuyichen on 15/12/20.
...
@interface Scan2DBarcodeController ()<UIAlertViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextFieldDelegate>
...
@implementation Scan2DBarcodeController
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    if (metadataObjects.count>0) {
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"查看" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            shufflFVC.URLstring = metadataObject.stringValue;
            [_session startRunning];
            [self presentViewController:navS animated:YES completion:nil];
        }]];
        [alert addAction:[UIAlertAction actionWithTitle:@"再次扫描" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
            [_session startRunning];
        }]];
...
-(void)myCode{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"我的二维码" preferredStyle:UIAlertControllerStyleAlert];
    [alert addAction:[UIAlertAction actionWithTitle:@"生成二维码" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        PopupViewController1 *popup = [PopupViewController1 new];
        STPopupController *popupController = [[STPopupController alloc] initWithRootViewController:popup];
        popupController.cornerRadius = 4;
        popupController.transitionStyle = STPopupTransitionStyleFade;
        popup.session = _session;
        [_session startRunning];
